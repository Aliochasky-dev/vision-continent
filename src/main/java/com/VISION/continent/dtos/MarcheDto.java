...
public class MarcheDto {
    ...
    @Getter @Setter @Builder
    @Schema(name = "MarcheCagnotteResponse")
    public static class CagnotteResponse {
        private UUID marcheId;
        private String question;
        private Marche.Statut statut;
        private BigDecimal poolOuiFcfa;
        private BigDecimal poolNonFcfa;
        private BigDecimal volumeTotalFcfa;
        private BigDecimal prixOui;
        private BigDecimal prixNon;
        private long nbParticipantsOui;
        private long nbParticipantsNon;
        private long nbParticipantsTotal;
    }
}